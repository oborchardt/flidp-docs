...
% --------------------------------------------------------------------------
%Federated Learning With Individualized Differential Privacy By Client Sampling
\newcommand{\titel}{Federated Learning mit individualisierter Differential Privacy durch Client Sampling}
...
\newcommand{\zweitbetreuer}{Lucas Lange}
\newcommand{\jahr}{2025}
\newcommand{\invnr}{1337}
\newcommand{\eingereicht}{08.01.2025}
